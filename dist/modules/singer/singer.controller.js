...
let SingerController = class SingerController {
    ...
    getSinger(response, id) {
        return __awaiter(this, void 0, void 0, function* () {
            const singer = yield this.singerService.getSinger(id);
            return response.status(common_1.HttpStatus.OK).json({ data: singer });
        });
    }
};
__decorate([
...
], SingerController.prototype, "getSinger", null);
SingerController = __decorate([
    common_1.Controller('singers'),
