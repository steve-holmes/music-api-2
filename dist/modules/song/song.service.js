...
let SongService = class SongService {
    constructor(songLoader, songRepository) {
        this.songLoader = songLoader;
        this.songRepository = songRepository;
    }
    getSong(id) {
        return __awaiter(this, void 0, void 0, function* () {
            let song = yield this.songRepository.findSong(id);
            song = yield this.songLoader.reponse(song.url);
            return { track: song };
        });
    }
};
SongService = __decorate([
    common_1.Component(),
    __metadata("design:paramtypes", [song_loader_1.SongLoader,
