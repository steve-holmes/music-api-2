...
let TopicController = class TopicController {
    ...
    getTopics(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const topics = yield this.topicService.getTopics();
            return response.status(common_1.HttpStatus.OK).json({ data: topics });
        });
    }
    getTopic(response, id) {
        return __awaiter(this, void 0, void 0, function* () {
            const topic = yield this.topicService.getTopic(id);
            return response.status(common_1.HttpStatus.OK).json({ data: topic });
        });
    }
};
__decorate([
...
], TopicController.prototype, "getTopics", null);
__decorate([
    common_1.Get('/:id'),
